-- Fix critical security vulnerability: Remove overly permissive policy that exposes personal information
...
-- 3. Create a secure view for public service provider information (business info only)
...
-- 4. Allow all authenticated users to view the public service provider info (no personal contact details)
ALTER TABLE public.service_provider_public_info OWNER TO postgres;
GRANT SELECT ON public.service_provider_public_info TO authenticated;